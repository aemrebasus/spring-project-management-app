...
public class SeedDatabase implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        tenTimes.accept(() -> userService.saveOne(
                new User(rnd.get(), "user" + rnd.get(), "firstName-" + rnd.get(), "lastName-" + rnd.get(), "email" + rnd.get() + "@gmail.com", "pass", "ADMIN", true, null, rndOrg.get())
        ));
        ...
        userService.saveOne(new User(rnd.get(), "user", "firstName-" + rnd.get(), "lastName-" + rnd.get(), "email" + rnd.get() + "@gmail.com", "pass", "ADMIN", true, null, rndOrg.get()));
